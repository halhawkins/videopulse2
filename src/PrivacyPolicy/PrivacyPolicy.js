...
render(){
    ...
    <div className="tos-section">
        <h2>VideoPulse Privacy Policy</h2>

        <p>VideoPulse (the &ldquo;Company&rdquo;) is committed to maintaining robust privacy protections for its users.  Our Privacy Policy (&ldquo;Privacy Policy&rdquo;) is designed to help you understand how we collect, use and safeguard the information you provide to us and to assist you in making informed decisions when using our Service.</p>  

        <p>For purposes of this Agreement, &ldquo;Site&rdquo; refers to the Company&apos;s website, which can be accessed at <a href="https://videopulse.tv" >https://www.videopulse.com</a>.</p>

        <p>&ldquo;Service&rdquo; refers to the Company&apos;s services accessed via the Site, in which users can learn about movies and television and keep track of shows to watch or already watched.</p>
        ...
        <p>By accessing our Site or our Service, you accept our Privacy Policy and Terms of Use (found here: <a href="https://videopulse.tv/page=tos">https://videopulse.tv/page=tos</a>), and you consent to our collection, storage, use and disclosure of your Personal Information as described in this Privacy Policy.</p>

        <p><h3>I. INFORMATION WE COLLECT</h3></p>

        <p>We collect &ldquo;Non-Personal Information&rdquo; and &ldquo;Personal Information.&rdquo; Non-Personal Information includes information that cannot be used to personally identify you, such as anonymous usage data, general demographic information we may collect, referring/exit pages and URLs, platform types, preferences you submit and preferences that are generated based on the data you submit and number of clicks. Personal Information includes your email, your user name and avatar, which you submit to us through the registration process at the Site.</p>

        <p><h4>1. Information collected via Technology</h4></p>
        ...
        <p>You&apos;re session status</p><p>Site preferences.</p>
        ...
        <p><h4>2. Information you provide us by registering for an account</h4></p>
        ...
        <p><h3>III. HOW WE PROTECT INFORMATION</h3></p>
        ...
        <p><h3>IV. YOUR RIGHTS REGARDING THE USE OF YOUR PERSONAL INFORMATION</h3></p>

        <p>You have the right at any time to prevent us from contacting you for marketing purposes.  When we send a promotional communication to a user, the user can opt out of further promotional communications by following the unsubscribe instructions provided in each promotional e-mail. You can also indicate that you do not wish to receive marketing communications from us in your profile settings for the Site. Please note that notwithstanding the promotional preferences you indicate by either unsubscribing or opting out in your profile settings, we may continue to send you administrative emails including, for example, periodic updates to our Privacy Policy.</p>

        <p><h3>V. LINKS TO OTHER WEBSITES</h3></p>
        ...
        <p><h3>VII. CONTACT US</h3></p>

        <p>If you have any questions regarding this Privacy Policy or the practices of this Site, please contact us by sending an email to <a href="mailto:support@videopulse.tv">support@videopulse.tv</a>.</p>

        <p>Last Updated: This Privacy Policy was last updated on May 13, 2022.</p>
    </div>
    );
}
}
